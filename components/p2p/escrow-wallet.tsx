...
export function ReceiveCryptoButton({ trade, onCompleted, onError }: EscrowButtonProps) {
  ...
  return (
    <div className="space-y-3 border border-moss/40 bg-moss/5 p-4">
      ...
      <div className="space-y-2">
        <label className={`flex cursor-pointer items-start gap-2 border p-3 text-sm ${mode === "connected" ? "border-ocean bg-white" : "border-line bg-panel"}`}>
        ...
        <label className={`flex cursor-pointer items-start gap-2 border p-3 text-sm ${mode === "address" ? "border-ocean bg-white" : "border-line bg-panel"}`}>
